/**
 * TABLE WARS! - Landing Screen
 * 
 * The initial gateway screen shown to the host before the competition begins.
 * Sets the tone for the event and allows the user to transition to the Setup view.
 * 
...
/**
 * @param onStart - Callback to signal the transition to the main application flow
 */
